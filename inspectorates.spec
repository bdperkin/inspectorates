...
for d in article manpage book; do %{__mkdir_p} $d; for f in chunked htmlhelp manpage text xhtml tex; do %{__mkdir_p} $d/$f; a2x -D $d/$f -d $d -f $f %{name}.8.asciidoc; done; done
